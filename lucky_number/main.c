...
extern double lucky_number();

int main(int argc, char* argv[]) {

    printf("\nWelcome to 'Lucky Number' maintained by Dianella Sy 🤗\n");

    double return_lucky_number = lucky_number();

    if (return_lucky_number == 3.14) {
        printf("\nCongratulations! You typed in the lucky number 🍀");
    } else {
